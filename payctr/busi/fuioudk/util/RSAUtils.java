...
public class RSAUtils {
   ...
   private static final String RSA_VER="3.0";
    ...
    public static String signMD5WithRSA(String data, String key) throws Exception{
		byte[] bytesKey = Base64Utils.getDecoder().decode(key.trim());
		...
		return new String(Base64Utils.getEncoder().encode(signature.sign()));
	}
	
    public static boolean verifySignMD5WithRSA(String sign, String signPlain, String key) throws Exception
	{
		byte[] keyBytes = Base64Utils.getDecoder().decode(key);
		...
		// 验证签名是否正常
		return signature.verify(Base64Utils.getDecoder().decode(sign));
	}
    ...
    public static String sign(byte[] data, String privateKey) throws Exception {
        byte[] keyBytes = Base64Utils.getDecoder().decode(privateKey);
    ...
    public static boolean verify(byte[] data, String publicKey, String sign)
            throws Exception {
        byte[] keyBytes = Base64Utils.getDecoder().decode(publicKey);
        X509EncodedKeySpec keySpec = new X509EncodedKeySpec(keyBytes);
        KeyFactory keyFactory = KeyFactory.getInstance(KEY_ALGORITHM);
    ...
    public static String getPrivateKey(Map<String, Object> keyMap)
        ...
        return new String(Base64Utils.getEncoder().encode(key.getEncoded()));
    }
