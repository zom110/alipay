 ...
 *
 */
public class BaofudfRspBF0040004 extends BaofudfBaseRsp {

    
    private List<Map<String, List<TransRespBF0040004>>> trans_reqDatas = new ArrayList<Map<String, List<TransRespBF0040004>>>() ;

    public BaofudfRspBF0040004() {
//        trans_reqDatas = new ArrayList<Map<String,List<TransRespBF0040004>>>() ; 
//        Map<String,List<TransRespBF0040004>> tmpMap = new HashMap<>() ;
//        trans_reqDatas.add(tmpMap); 
    }
    
    public void setTrans_reqDatas(List<Map<String, List<TransRespBF0040004>>> trans_reqDatas) {
        this.trans_reqDatas = trans_reqDatas;
    }

    public List<Map<String, List<TransRespBF0040004>>> getTrans_reqDatas() {
        return trans_reqDatas;
    }

    public static class TransRespBF0040004 {
